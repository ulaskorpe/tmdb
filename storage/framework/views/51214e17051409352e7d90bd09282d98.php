            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-list"></i><a href="<?php echo e(route( 'movie-list')); ?>">List Movies</a></li>
                        <li><i class="fa fa-search"></i><a href="<?php echo e(route('movie-search')); ?>">Find Movies</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-list"></i><a href="<?php echo e(route('genre-list')); ?>">List Genres</a></li>
...
<?php /**PATH /home/vagrant/code/tmdb_project/resources/views/panel/partials/left_menu.blade.php ENDPATH**/ ?>