            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-download"></i><a href="ui-buttons.html">Get Movies</a></li>
                        <li><i class="fa fa-list"></i><a href="ui-badges.html">List Movies</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-fa-download"></i><a href="ui-buttons.html">Get Movies</a></li>
                        <li><i class="fa fa-list"></i><a href="ui-badges.html">List Movies</a></li>
