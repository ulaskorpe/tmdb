                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="search-form">
                                ...
                                <form class="form" id="search-form" name="search-form" action="{{route('movie-search-post')}}"
                                method="post" enctype="multipart/form-data">
                                <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
                                
                                    <div class="form-group">
                                        <label>Search For :</label>
                                        <input type="text" id="keyword" name="keyword" class="form-control" placeholder="Movie name .. ">
                                    </div>
