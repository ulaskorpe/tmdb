                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form class="form" id="user-form" name="user-form" action="{{ route('users.store') }}"
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" id="admin_code" name="admin_code" value="{{$user_code}}">
                                        <input type="text"  disabled
                                            value="{{ $user_code }}" class="form-control">
...
if ($('#email').val() == '') {
    ...
    await   $.get('/admin-panel/check-email/' + $('#email').val(), function(data, status) {
                    // alert("Data: " + data + "\nStatus: " + status);
        ...
        $('#user-form').submit(function(e) {
            ...
            //function save(formData,route,formID,btn,reload) {
                ...
                var formData = new FormData(this);
                    ...
                    save(formData, '{{ route('users.store') }}', 'user-form', '', false);
                    setTimeout(function() {
